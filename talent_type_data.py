...
TYPE_NAMES = {
    # === CD 认知洞察 + 深度沉浸 ===
    "CDAM": {"name": "深渊哲学家", "tagline": "在独处的深渊里，打捞那些所有人都看不见的真相。"},
    "CDAC": {"name": "哲思创造者", "tagline": "想得很深，做得很美。思想是你的土壤，创造是你的果实。"},
    "CDAP": {"name": "思想传道者", "tagline": "你看到的真相，值得被更多人听见。"},
    "CDHM": {"name": "废墟考古学家", "tagline": "从过去的废墟中，挖掘出未来的地图。"},
    "CDHC": {"name": "创伤解码者", "tagline": "你擅长把痛苦翻译成创造的密码。"},
    "CDHP": {"name": "觉醒先知", "tagline": "经历过黑暗，所以更能为别人点亮一盏灯。"},
    # === CR 认知洞察 + 快速响应 ===
    "CRAM": {"name": "闪电辩论家", "tagline": "思维如电光火石，瞬间照亮问题的核心。"},
    "CRAC": {"name": "即兴思想家", "tagline": "在混乱中思考，在压力下创造，越紧急越清醒。"},
    "CRAP": {"name": "现场解读者", "tagline": "别人还在发愣，你已经看穿了局面。"},
    "CRHM": {"name": "急诊室哲学家", "tagline": "在危机中保持冷静，在混乱中找到秩序。"},
    "CRHC": {"name": "危机破译者", "tagline": "压力是你的燃料，复杂是你的游乐场。"},
    "CRHP": {"name": "战场军师", "tagline": "你天生擅长在瞬息万变中做出最优判断。"},
    # === CV 认知洞察 + 多元切换 ===
    "CVAM": {"name": "跨界拼图师", "tagline": "你能看到不同领域之间的隐藏连接。"},
    "CVAC": {"name": "灵感永动机", "tagline": "一个念头点燃另一个念头，你的大脑从不熄火。"},
    "CVAP": {"name": "知识游牧者", "tagline": "你在多个领域间自由迁徙，处处留下智慧的痕迹。"},
    "CVHM": {"name": "破碎重组者", "tagline": "把打碎的认知重新拼成更完整的图景。"},
    "CVHC": {"name": "废墟发明家", "tagline": "在别人放弃的残骸上，搭建出全新的可能。"},
    "CVHP": {"name": "万花筒智者", "tagline": "同样的世界，在你眼中折射出无数种光芒。"},
    # === RD 关系创造 + 深度沉浸 ===
    "RDAM": {"name": "灵魂聆听者", "tagline": "你能听到别人心里没说出口的话。"},
    "RDAC": {"name": "故事疗愈师", "tagline": "用故事编织理解，用倾听治愈伤口。"},
    "RDAP": {"name": "深度联结者", "tagline": "你不追求朋友数量，只追求连接的深度。"},
    "RDHM": {"name": "伤痛共鸣者", "tagline": "别人的痛苦在你这里不是噪声，而是信号。"},
    "RDHC": {"name": "暗夜园丁", "tagline": "在别人心灵的荒原上，默默种出一片花园。"},
    "RDHP": {"name": "觉醒疗愈者", "tagline": "你自己穿越过黑暗，所以知道怎么带别人走出来。"},
    # === RR 关系创造 + 快速响应 ===
    "RRAM": {"name": "氛围魔术师", "tagline": "你一出现，空气就变了。"},
    "RRAC": {"name": "即兴表演者", "tagline": "生活是你的舞台，每一次互动都是即兴创作。"},
    "RRAP": {"name": "社交催化剂", "tagline": "你能让一群陌生人，在十分钟内变成朋友。"},
    "RRHM": {"name": "能量修复师", "tagline": "你能瞬间察觉到谁需要被看见、被理解。"},
    "RRHC": {"name": "痛苦转化者", "tagline": "把尴尬变成笑声，把冲突变成理解。"},
    "RRHP": {"name": "觉醒号召者", "tagline": "你的存在本身就是一种召唤，让人想要变得更好。"},
    # === RV 关系创造 + 多元切换 ===
    "RVAM": {"name": "网络编织者", "tagline": "你在人与人之间织出一张看不见的网。"},
    "RVAC": {"name": "关系艺术家", "tagline": "每一段关系在你手中都是一件独特的作品。"},
    "RVAP": {"name": "社群枢纽", "tagline": "你是那个把散落的人连接成共同体的人。"},
    "RVHM": {"name": "关系拾荒者", "tagline": "在别人忽视的角落，找到被遗忘的连接。"},
    "RVHC": {"name": "跨界疗愈者", "tagline": "你能跨越边界，把不同的人带到一起。"},
    "RVHP": {"name": "觉醒连接者", "tagline": "你连接的不只是人，更是灵魂与灵魂之间的桥梁。"},
    # === BD 身体实践 + 深度沉浸 ===
    "BDAM": {"name": "匠人", "tagline": "用双手和耐心，把粗糙变成精致。"},
    "BDAC": {"name": "造物主", "tagline": "你脑中有一个世界，然后你把它做了出来。"},
    "BDAP": {"name": "双手传道者", "tagline": "你不擅长说，但你擅长做给别人看。"},
    "BDHM": {"name": "废墟重建者", "tagline": "打碎了也不怕，你总能把它修得更好。"},
    "BDHC": {"name": "创伤雕刻家", "tagline": "把经历过的痛，雕刻成有力量的作品。"},
    "BDHP": {"name": "觉醒工匠", "tagline": "你的每一件作品，都刻着你对生命的理解。"},
    # === BR 身体实践 + 快速响应 ===
    "BRAM": {"name": "行动哲学家", "tagline": "你想得少，做得快，错了就改，改了更好。"},
    "BRAC": {"name": "即兴创作者", "tagline": "最好的作品往往诞生于最不完美的时刻。"},
    "BRAP": {"name": "冒险家", "tagline": "你身体的本能比大脑更知道方向。"},
    "BRHM": {"name": "危机响应者", "tagline": "别人还在分析，你已经冲上去解决了。"},
    "BRHC": {"name": "废墟征服者", "tagline": "越是破败的地方，越能激发你的斗志。"},
    "BRHP": {"name": "觉醒战士", "tagline": "你用自己的行动，证明改变是可能的。"},
    # === BV 身体实践 + 多元切换 ===
    "BVAM": {"name": "多面手匠人", "tagline": "你会的太多，以至于很难被定义。"},
    "BVAC": {"name": "百变创作者", "tagline": "今天做木工，明天做料理——创造力是你的通用语言。"},
    "BVAP": {"name": "全能连接者", "tagline": "你能动手，也能交心，是少见的双全型人才。"},
    "BVHM": {"name": "万物修复师", "tagline": "坏的、破的、散的，到你手里都能复原。"},
    "BVHC": {"name": "跨界艺术家", "tagline": "你把不同媒介混合在一起，创造出全新的表达。"},
    "BVHP": {"name": "觉醒多面手", "tagline": "你不需要被定义，因为你本身就是一个完整的生态。"},
    # === SD 系统引领 + 深度沉浸 ===
    "SDAM": {"name": "战略家", "tagline": "在别人看眼前的时候，你已经在看三年后的棋盘。"},
    "SDAC": {"name": "建筑师", "tagline": "你不只是设计蓝图，你还亲手打下第一块砖。"},
    "SDAP": {"name": "蓝图传道者", "tagline": "你能把复杂的愿景，翻译成每个人都能执行的步骤。"},
    "SDHM": {"name": "废墟规划师", "tagline": "在混乱中看见秩序，在废墟中画出重建的图纸。"},
    "SDHC": {"name": "创伤重构者", "tagline": "你把破碎的系统重新拼成更坚韧的结构。"},
    "SDHP": {"name": "觉醒建筑师", "tagline": "你建造的不只是系统，更是人们可以安心生活的秩序。"},
    # === SR 系统引领 + 快速响应 ===
    "SRAM": {"name": "指挥官", "tagline": "你天生知道该让谁做什么，以及什么时候做。"},
    "SRAC": {"name": "变革推动者", "tagline": "你不等待许可，你看到方向就带头冲。"},
    "SRAP": {"name": "领袖", "tagline": "人们愿意跟随你，不是因为你的头衔，而是因为你的方向。"},
    "SRHM": {"name": "危机指挥官", "tagline": "混乱越大，你的思路越清晰，气场越稳。"},
    "SRHC": {"name": "废墟重建者", "tagline": "组织崩溃了？交给你，三个月恢复运转。"},
    "SRHP": {"name": "觉醒统帅", "tagline": "你领导的不只是人，更是他们内心深处的使命感。"},
    # === SV 系统引领 + 多元切换 ===
    "SVAM": {"name": "生态构建者", "tagline": "你不只搭建一个系统，你搭建一个能自我运转的生态。"},
    "SVAC": {"name": "平台创造者", "tagline": "你建舞台，让别人在上面发光。"},
    "SVAP": {"name": "网络架构师", "tagline": "你把散落的能力连接成一张有生命力的网络。"},
    "SVHM": {"name": "碎片整合者", "tagline": "你能在混乱的碎片中，看见一个完整系统的雏形。"},
    "SVHC": {"name": "跨界系统师", "tagline": "你把不同领域的规则打通，创造全新的协作方式。"},
    "SVHP": {"name": "觉醒组织者", "tagline": "你组织的不是任务，是人们彼此之间的信任。"},
}
